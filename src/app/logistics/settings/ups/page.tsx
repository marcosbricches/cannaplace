// src/app/logistics/settings/ups/page.tsx
...
// Similar ao courier/page.tsx mas com alterações específicas para UPS
        ...
        <div className="max-w-3xl mx-auto p-8">
          <div className="mb-8">
            ...
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Configuração UPS</h1>
                <p className="text-gray-500 mt-1">Configure a integração com a API da UPS</p>
              </div>
              <Badge variant="secondary">Standby</Badge>
            </div>
          </div>
   
          {/* Conteúdo similar ao Courier, com alterações específicas para UPS */}
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <div className="font-medium">API UPS</div>
                    <div className="text-sm text-gray-500">Modo: Failover (Backup)</div>
                  </div>
                  <Switch />
                </div>
              </CardContent>
